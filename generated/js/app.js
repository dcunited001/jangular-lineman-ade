/*! An HTML/JS/CSS app using Angular.JS - v0.0.1 - 2013-12-07 */
//     Underscore.js 1.5.2
...
var app = angular.module("RailsStackApp", 
  ...
  //TODO: fix http interceptor, success/error functions seem to be overriding other callbacks
    var interceptor = function($location, $rootScope, $q, SessionService) {
...
// app.directive('userProfilePopoverPopup', function() {
//   //TODO: find a way to override bootstrap's popover template
//   return {
//     restrict: 'EA',
//     replace: true,
//     scope: { title: '@', content: '@', placement: '@', animation: '&', isOpen: '&' },
//     templateUrl: 'angular/directives/user-profile-popover.html'
//   }
// });

// app.directive('userProfilePopover', function($compile, $timeout, $parse, $window, $tooltip) {
//   return $tooltip( 'popover', 'popover', 'click' );
// });
